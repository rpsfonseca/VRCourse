...
public class VRLookWalk : MonoBehaviour
{
    ...
    void Update()
    {
        if (!GameManager.instance.focused)
        {
            // right
            ...
            if (InteractionManager.currentInteractable != null && (Input.GetKeyDown(KeyCode.JoystickButton12) || Input.GetKeyDown(KeyCode.C)))
            {
                Debug.Log("Interaction on button press");
        ...
        {
            if (InteractionManager.currentInteractable != null && InteractionManager.currentInteractable.interactionType == InteractionManager.InteractionType.PRESS_AND_FOCUS && (Input.GetKeyDown(KeyCode.JoystickButton12) || Input.GetKeyDown(KeyCode.C)))
            {
                Debug.Log("Interaction on button press");
                InteractionManager.Disengage();
            }
        }
    }
}
